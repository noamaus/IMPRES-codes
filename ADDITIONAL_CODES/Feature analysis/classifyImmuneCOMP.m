function [AUC, score, label, jj, X0, X1,signd3] = classifyImmuneCOMP(Data,CPall,F,Pos,Neg,plotROC)

%%%Classify based on comparisons of the F pairs from CPall generated table, using ratios instead of binary relations        
